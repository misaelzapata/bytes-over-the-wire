"""constants.py -- single source of truth for every gameplay/tuning number.

Mirrors server/constants.js EXACTLY (SPEC §15). Numeric values are identical to
the Node reference so the shared client sees an identical world.
"""
...
BOOST_SPEED = 60           # |moveEngine| above this (u/s) => "boosting"
...
# --- merge / recombine ---
NO_MERGE_TICKS = 15        # hard lockout right after a split
...
RESYNC_EVERY = 250         # ~10s safety net
